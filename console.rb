...
customer1 = Customer.new({'name' => "Gilbert", 'funds' => 42.99})
customer1.save()
customer2 = Customer.new({'name' => "Gregory", 'funds' => 88.99})
customer2.save()
customer3 = Customer.new({'name' => "Tonia", 'funds' => 13.99})
customer3.save()
customer4 = Customer.new({'name' => "Theresa", 'funds' => 92.99})
customer4.save()
customer5 = Customer.new({'name' => "Frankie", 'funds' => 120.99})
customer5.save()
customer6 = Customer.new({'name' => "Jennifer", 'funds' => 98.99})
customer6.save()
customer7 = Customer.new({'name' => "Percy", 'funds' => 34.99})
customer7.save()
customer8 = Customer.new({'name' => "Carleen", 'funds' => 64.99})
customer8.save()
